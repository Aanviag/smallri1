...
/* ------------------------------------------------------------------------
   ...
   None of these require an API key for this volume of requests, but the
   Census Bureau asks high-volume users to register for a free key at
   https://api.census.gov/data/key_signup.html — if you get one, set
   CENSUS_API_KEY below and it'll be appended to every Census request.
...
const CENSUS_API_KEY = ""; // optional: paste a free key from api.census.gov here

const ACS_YEAR = 2023; // latest ACS 5-year vintage (2019-2023 estimates, released Dec 2024)
const ACS_PRIOR_YEAR = ACS_YEAR - 5; // for 5-year growth comparison
const CBP_YEAR = 2023; // latest County Business Patterns vintage (released June 2025)
