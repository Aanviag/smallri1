...
// NOTE ON VERIFICATION: entries below were checked against each org's own
// site/contact page. A couple could not be independently confirmed as real
// RI organizations at the address/phone given (flagged inline) — verify
// those two directly before relying on them in a public submission.
const RESOURCES = [
  ...
  // UNVERIFIED — could not confirm this org/address independently. Double-check before relying on it.
  { tag: "CDFI Lending", name: "Community Investment Corporation", desc: "Microloans and credit-building products for founders shut out of bank lending.", addr: "1265 Main St, Warwick", phone: "(401) 421-1105", county: "kent", website: null },
  ...
  // UNVERIFIED — could not confirm this org/address independently. Double-check before relying on it.
  { tag: "CDFI Lending", name: "East Bay Community Loan Fund", desc: "Small-dollar loans for East Bay storefronts, with bilingual application support.", addr: "16 Gooding Ave, Bristol", phone: "(401) 253-9100", county: "bristol", website: null },
